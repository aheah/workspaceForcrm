...
<script type="text/javascript">
	$(function(){
		...
		//为搜索操作模态窗口的搜索框绑定事件，执行搜索并展现市场活动列表的顺序
        ...
        $("#convertBtn").click(function (){
            ...
            * */
            if ($("#isCreateTransaction").prop("checked")){
                ...
                //window.location.href = "workbench/clue/convert.do?clueId=${param.id}&money=xxx&expectedDate=xxx&name=xxx&stage=xxx&activityId=xxxx";
                //以上传递参数的方式很麻烦，而且表单一旦扩充，挂载的参数有可能超出浏览器地址栏的上限
                //我们想到使用提交交易表单的形式来发出本次的传统请求
                //提交表单的参数不用我们手动取挂载（表单中写name属性），提交表单能够提交post请求
...
<body>
	...
	<div id="title" class="page-header" style="position: relative; left: 20px;">
		...
		<%--${pageContext.request.contextPath}--%>
			...
			<%
				...
				pageContext.setAttribute("str1",pageContext.SESSION_SCOPE);
			%>--%>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
	    <%--
	        提交表单行为结果:
	        workbench/clue/convert.do?clueId=xxx&money=xxx&money=xxx&name=xxx.......&flag=a
    	--%>
