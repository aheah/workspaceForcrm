...
import com.ly.crm.workbench.dao.*;
import com.ly.crm.workbench.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        /*
        * 经过第二步处理后，客户的信息我们已经拥有了，将来在处理其他表的时候，如果要是有到客户的id
        * 直接使用cus.getId();
        * */
        ...
        //经过第三步处理后，来呢西人的信息我们已经有了，将来在处理其他表的时候，如果要使用到联系人的id
        //直接使用con.getId();
        ...
        //查询出与改条线索关联的市场活动，查询与市场活动的关联关系列表
