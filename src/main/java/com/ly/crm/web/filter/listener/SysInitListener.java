package com.ly.crm.web.filter.listener;

import com.ly.crm.settings.domain.DicValue;
import com.ly.crm.settings.service.DicService;
import com.ly.crm.settings.service.impl.DicServiceImpl;
...
public class SysInitListener implements ServletContextListener {
    /*
    *
    * 该方法是用来监听上下文域对象的方法，当前服务器启动，上下文域对象创建
    * 对象创建完毕后，马上执行该方法
    * event:该参数能够取得监听的对象
    *       监听的是什么对象，就可以通过该参数取得什么对象
    *       例如我们现在监听的的是上下文域对象，通过该参数就可以取得上下文域对象
    *
    * */
    @Override
