...
<script type="text/javascript" src="jquery/bootstrap-datetimepicker-master/locale/bootstrap-datetimepicker.zh-CN.js"></script>
	...
	$(function(){
		...
		$("#addBtn").click(function (){
			...
			*
			* 操作模态窗口的方式:
			* 	需要操作的模态窗口的jquery对象，调用modal，为该方法传递参数 show:打开模态窗口，hide:关闭模态窗口
			*
			* */
			//$("#createActivityModal").modal("show");
			//走后台，目的是为了取得用户信息列表（ajax）
			$.ajax({
				...
				success:function (data){
					/*
					* 后台返回的是List<User> ulist
					* 解析成json格式
					* data[{"id":?,"loginAct":?...}，{用户2}，{用户3}...]
					* */
				...
				success:function (data){
                    ...
                    * */
					if (data.success){
						...
						* 	但是表单的jquery对象，没有为我们提供rest()方法来重置表单，即使idea会提示我们
						* 	虽然jquery对象没有为我们提供reset方法，但是原生js为我们提供了reset方法
						* 	所以我们要将jquery对象转为原生dom对象
						* 	jquery对象转换成dom对象，
						* 	jquery对象[下标]
						*	dom对象转换为jquery对象
						* 	$(dom)
						*
						* */
						/*$("#activityAddForm")[0].reset();似乎不可用（低版本的jquery）*/
						//用简单暴力方法
						$("#create-name").val("");
					...
					success: function (data) {
						...
						* */
						...
						$.each(data.uList,function (i,n){
							html += "<option value='"+ n.id +"'>" + n.name + "</optoin>";
						})
	...
	* 我们都在哪些情况下，需要调用pageList方法（什么情况下需要刷新一下市场活动信息列表）
			...
			success:function (data){
				...
				* */
				...
				$.each(data.dataList,function (i,n){
					...
					html += '<td><input type="checkbox" name="xz" value="'+ n.id +'"></input></td>';
	...
	<div class="modal fade" id="createActivityModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 85%;">
			<div class="modal-content">
				...
				<div id="activityAddForm" class="modal-body">
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 81%;">
								<%--
									关于文本域textarea：
										(1)一定是要以标签对形式来呈现，正常状态下标签对要紧挨着
										(2)textarea虽然是以标签对形式呈现的，但是它也是属于表单元素范畴
		...
		<div style="width: 100%; position: absolute;top: 5px; left: 10px;">
			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<%--	<tr class="active">
							&lt;%&ndash;<td><input type="checkbox" /></td>
