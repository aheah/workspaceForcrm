...
<script type="text/javascript" src="jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
	<script>
		...
		* 	(2)这是一种键值对的对应关系
		*
		* 如果同时满足以上两种结论，那么我们将这样的数据保存到数据库中就没有意义了
		* 如果遇到这种情况，我们需要用到properties属性文件进行保存
		* stage2Possibility.properties(对中文支持很差，得转码)
		* 01资质审查=10
		* 02需求分析=25
		* ......
		*
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="activityId" value="04569c49b8b241c089a81e1e3f6e65fa">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" name="contactsId" value="fff2c8abf7e94526a79fbf4edba14c57">
			</div>
		</div>
